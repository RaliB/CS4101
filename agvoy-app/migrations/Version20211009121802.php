 ...
 */
final class Version20211009121802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, prenom VARCHAR(100) NOT NULL, mail VARCHAR(100) NOT NULL, password VARCHAR(100) NOT NULL)');
        $this->addSql('CREATE TABLE indisponibilite (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, datedebut DATE DEFAULT NULL, datefin DATE DEFAULT NULL)');
